  ...
  <form action="test.html" method="post" class="layout-form">
    <main class="content cart">
      <div class="container">
        ...
        <div v-if="selectedProduct.length === 0" class="sheet cart__empty">
    ...
    <section v-if="selectedProduct.length > 0" class="footer">
...
import { CART, Actions } from "@/store/modules/cart.store";
